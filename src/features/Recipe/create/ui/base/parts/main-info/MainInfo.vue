<template>
	<div class="pt-[20px]">
		<VAddPhoto
			...
			backgrounds="#F3F3F3"
			:icon="IconPhoto"
			:initial-image="String(model.image ?? '')"
...
import { CreateBaseRecipeModel } from 'features/Recipe/create/model/base/use-base-recipe-creation-validation.ts'
...
const categoryKeys = ['diet_type_id', 'category_id', 'cuisine_id'] satisfies (keyof CreateBaseRecipeModel)[] as const
...
function onEntityValueUpdated(value: CreateBaseRecipeModel[CategoryKey]) {
