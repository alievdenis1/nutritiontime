...
import {
	type ManageRecipeIngredientModel,
	useIngredientValidation
...
const emit = defineEmits<{
	add: [model: ManageRecipeIngredientModel]
}>()
...
function revalidateField (key: keyof ManageRecipeIngredientModel) {
	validateField(key)
}
</script>
