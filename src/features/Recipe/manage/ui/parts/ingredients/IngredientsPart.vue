...
import type { ManageRecipeIngredientModel } from 'features/Recipe/manage/model/use-manage-recipe-validation.ts'
...
function onIngredientAdded(ingredient: ManageRecipeIngredientModel) {
