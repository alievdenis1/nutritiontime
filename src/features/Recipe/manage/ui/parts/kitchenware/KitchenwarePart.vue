...
import AddKitchenwareModal from './AddKitchenwareModal.vue'
import { ManageRecipeKitchenwareModel } from 'features/Recipe/manage/model/use-manage-recipe-validation.ts'
...
function onKitchenwareAdded(kitchenware: ManageRecipeKitchenwareModel) {
