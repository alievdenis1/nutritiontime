...
export const mockTWA: TWA = {
	...
	MainButton: {
		...
		isActive: true,
		hasShineEffect: '', // Добавлено это свойство
		setText: (text: string) => {
	...
	SecondaryButton: {
		...
		hasShineEffect: '', // Добавлено это свойство
		setText: (text: string) => {
			console.log('Setting SecondaryButton text:', text)
		},
		onClick: (callback: () => void) => {
			callback()
		},
		...
		show: () => {
			console.log('Showing SecondaryButton')
		},
		hide: () => {
			console.log('Hiding SecondaryButton')
		},
		enable: () => {
			console.log('Enabling SecondaryButton')
		},
		disable: () => {
			console.log('Disabling SecondaryButton')
		},
		showProgress: (leaveActive?: boolean) => {
			console.log('Showing SecondaryButton progress, leaveActive:', leaveActive)
		},
		hideProgress: () => {
			console.log('Hiding SecondaryButton progress')
		},
		setParams: (params: {
			text?: string
			color?: string
			...
			console.log('Setting SecondaryButton params:', params)
		}
	},
	HapticFeedback: {
		impactOccurred: (
	...
	setBottomBarColor: (color: string) => {
		console.log(`Setting bottom bar color to ${color}`)
		mockTWA.bottomBarColor = color
	}
}
